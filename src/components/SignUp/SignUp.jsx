...
const SignUp = () => {
  // ! Use Context from context component
  const contextValue = useContext(authContext);
  const {handleGoogleLogin,handleGithub,handleTwitter,handleSignUp} = contextValue;
  ...
  const handleSubmit = ( (e)=> {
    ...
    <div className="mb-5">
              <button onClick={handleGoogleLogin} className="bg-white rounded-full py-3 px-5 font-bold text-black flex items-center gap-3"><FcGoogle /> Sign up with Google</button>
            </div>
            <div className="mb-5">
              <button onClick={handleGithub} className="bg-white rounded-full py-3 px-5 font-bold text-black flex items-center gap-3"><ImGithub /> Sign up with Github</button>
            </div>
    </div>
    <div className='flex w-full space-x-3'>
    <div className="mb-5">
              <button className="bg-white rounded-full py-3 px-5 font-bold text-black flex items-center gap-3"><FaFacebook /> Sign up with Facebook</button>
            </div>
            <div className="mb-5">
              <button onClick={handleTwitter} className="bg-white rounded-full py-3 px-5 font-bold text-black flex items-center gap-3"><BsTwitterX /> Sign up with Twitter</button>
            </div>
    </div>
